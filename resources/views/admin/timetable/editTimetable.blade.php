        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('timetable.update', ['group_id' => $group_id, 'timetable' => $item->id]) }}">
                            @csrf
                ...
                @if($item->exists)
                    <br>
                    <form method="POST" action="{{ route('timetable.update', [ $item->id, 'group_id' => $group_id, 'timetable' => $item->id]) }}">
                        @method('DELETE')
                        @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-12">
