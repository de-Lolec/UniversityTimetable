    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <p class="text-center"><strong>     {{ $days_week[$block->day_num] }}</strong></p>
            </div>
            <div class="col-sm text-right">
                <p class="text-end"><strong>    {{ $current=\Carbon\Carbon::now()->addDays($block->day_num)->format('d.m.Y') }}</strong></p>
            </div>
